...
ROOT_URLCONF = 'meiduo111.urls'   #文件名

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, '../../meiduo111/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'meiduo111.wsgi.application'
...
EMAIL_PORT = 25
#发送邮件的邮箱
EMAIL_HOST_USER = 'yangwenkai94@163.com'
#在邮箱中设置的客户端授权密码
